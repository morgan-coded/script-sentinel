...
/**
 * Full round-trip test for the fixtures pipeline — extractor → upsert → read-back.
 * Uses the real Prisma schema (the cart-fixtures migration was applied during
 * setup). Same pattern as the scripts persistence test: unique shop domain
