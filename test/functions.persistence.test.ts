...
/**
 * Round-trip test for Slice 5 — discovery upsert, capture-run lifecycle,
 * function-output persistence + idempotent re-runs. Uses the real Prisma
 * schema (slice5_functions_capture migration was applied in setup).
 */
