...
/**
 * Regression round-trip — RegressionRun + DriftAlert lifecycle, plus an
 * end-to-end test of `runRegressionForShop` reading real fixture baselines
 * and function outputs out of Prisma. Uses a unique shop per file so the
