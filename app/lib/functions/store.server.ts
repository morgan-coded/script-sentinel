/**
 * Persistence boundary for Slice 5 — DiscoveredFunction, CaptureRun,
 * FunctionOutput.
 *
 * Reuses the Slice 3 extractor + dedup signature so FunctionOutput rows
 * align with CartFixture rows by `fixtureSignature`. Slice 6's diff engine
 * reads both and compares apples-to-apples.
 */
