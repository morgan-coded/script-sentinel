/**
 * Slice 7 — Drift alert email template.
 *
 ...
 * react-dom/server.
 *
 * Slice 7 v1 only RENDERS; the cron handler currently logs the rendered HTML
 ...
 * sender reputation, which isn't a Slice 7 architectural decision.
 *
