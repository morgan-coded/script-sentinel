...
function extractShipping(raw: RawOrder): {
  ...
  // most orders have exactly one. Multi-leg shipments aren't a Slice 3
  // concern; Slice 6 will refine this.
...
function cartTotalFor(raw: RawOrder): number {
  ...
  // and matches what we need for Slice 6 diff comparisons.
  let total = 0;
