...
describe("runDiff — graceful empty-shop contract", () => {
  it("returns the zero state for empty inputs (phase contract)", () => {
...
describe("segment tagging (computeSegments)", () => {
...
describe("runDiff appends segment tags to drift result categories", () => {
