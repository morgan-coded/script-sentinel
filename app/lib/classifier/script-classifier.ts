 ...
 *
 * The launch implementation is deterministic only. The optional classifier
 * interface below is an extension point for a later second-pass classifier.
 */
...
/**
 * Optional future classifier extension point. The launch implementation is
 * deterministic only; pass null when no second-pass classifier is available.
 */
