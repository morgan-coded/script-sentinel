          ...
          <BlockStack gap="500">
            ...
            <Card>
              <BlockStack gap="200">
                ...
                <Text as="p" variant="bodySm" tone="subdued">
                  The fixture generator builds cart fixtures from your
                  standard 60-day order window. The audit then turns this
                  script's classification + the fixtures into a Migration Risk
                  PDF.
                </Text>
