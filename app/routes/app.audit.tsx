...
/**
 * Migration Risk Audit. The $199 / $499 paid audit route.
 *
 * Flow:
...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  if (intent === "generate") {
    ...
    // Run the diff engine BEFORE building the snapshot so the PDF
...
export default function Audit() {
  ...
  // Toast on action success. We surface a one-line confirmation
...
/**
 * Friendly route-level error boundary. Catches loader/action
