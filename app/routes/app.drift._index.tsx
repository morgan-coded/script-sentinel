          ...
          <Card>
            <BlockStack gap="300">
              ...
              <Text as="p" variant="bodySm" tone="subdued">
                Joins your fixture baselines (Script-era) to your captured
                Function outputs (Function-era) by fixture signature. Severity
                per category — discount, shipping, payment, totals — bubbles
                up to a fixture-level grade. Match and "untested in
                production" counts surface in stats but aren't alerts.
              </Text>
              <InlineStack gap="200">
